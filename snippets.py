...
@handler("creator")
def process_creator(self, node):
	self.document.creators.append(extract_paired(self, node))

@handler("contributor")
def process_contributor(self, node):
	self.document.contributors.append(extract_paired(self, node))
